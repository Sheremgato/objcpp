...
private:
    ...
    int age;
    std::string email;
    std::string address;  // Новое поле для адреса
...
int main() {
    ...
    // Устанавливаем корректные значения с помощью сеттеров
    person.setName("John Doe");
    person.setAge(25);
    person.setEmail("john.doe@example.com");
    person.setAddress("123 Main St, Springfield");
    ...
    // Выводим информацию после неудачных попыток
    person.displayInfo();
